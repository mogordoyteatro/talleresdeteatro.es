...
'/blog/articulo/':[
{sel:'.breadcrumb a[href="/"]',html:'Inici'},
{sel:'.breadcrumb a[href="/blog/"]',html:'Lectures'},
{findText:'.mq-eyebrow',from:'Cuestionario',to:'Qüestionari'},
{sel:'.mq-title',html:'¿Ho tens<br>clar?'},
{findText:'.mq-subtitle',from:'3 preguntas sobre lo que acabas de leer.',to:'3 preguntes sobre el que acabes de llegir.'},
{sel:'.mq-cta-btn',html:'Explorar tots els qüestionaris →'},
{sel:'.footer-links a[href="/principiantes/"]',html:'Principiants'},
{sel:'.footer-links a[href="/intermedios/"]',html:'Amb experiència'},
{sel:'.footer-links a[href="/contacto/"]',html:'Contacte'},
{sel:'.footer-links a[href="/blog/"]',html:'Lectures'},
{findText:'.footer-copy',from:'© 2026 Talleres de Teatro Barcelona · Gràcia',to:'© 2026 Tallers de Teatre Barcelona · Gràcia'},
],
'/cuestionario/':[
{sel:'.nav-back',html:'← Lectures'},
{findText:'.landing-eyebrow',from:'Talleres de Teatro · Barcelona',to:'Tallers de Teatre · Barcelona'},
{sel:'.landing-title',html:'TEATRE<br><em>QÜESTIONARI</em>'},
{findText:'.landing-desc',from:'Elige un tema y pon a prueba lo que sabes.',to:'Tria un tema i posa a prova el que saps.'},
{findText:'.landing-count',from:'9 temas · 4 preguntas cada uno',to:'9 temes · 4 preguntes cadascun'},
{sel:'#quiz-back-btn',html:'← Temes'},
{findText:'#q-counter, .q-counter',from:'Pregunta',to:'Pregunta'},
{findText:'#hint-btn, .hint-btn',from:'▸ PISTA',to:'▸ PISTA'},
],
};
